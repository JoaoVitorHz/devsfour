...
export function InputsUpdateProduct({ onClick }: Props) {
            ...
            <div className="grid grid-cols-2 gap-3 mb-8">
                ...
                <div className="flex flex-col">
                    ...
                    <select
                        name=""
                        id=""
                        className="text-gray-500 border border-solid border-gray-400 rounded-sm px-3 h-10"
                    >
                ...
                <div className="flex flex-col">
                    ...
                    <input
                        type="text"
                        className="border border-solid border-gray-400 rounded-sm px-3 py-2 text-gray-500 bg-slate-300"
                        placeholder="Digite o nome do produto"
                        value={productPrice}
                        disabled
                        onChange={(e) => setProductPrice(e.target.value)}
